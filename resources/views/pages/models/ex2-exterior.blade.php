<x-layouts.app>
    @push('head')
        ...
        <meta name="keywords" content="Geely EX2 Eksterior, Desain Geely EX2, Mobil Listrik Urban, Crossover EV Geely, 360 Geely EX2, Geely bsd, Geely Tangerang, Mobil Listrik BSD, SUV Geely">
    ...
    <style>
        ...
        body {
            /* Latar belakang disamakan dengan index (terang) */
        ...
        /* 360 Studio Motif diubah agar cocok dengan tema terang */
        .bg-studio-motif {
            background-image: 
                linear-gradient(120deg, transparent 30%, rgba(255, 255, 255, 0.8) 38%, rgba(255, 255, 255, 1) 40%, rgba(255, 255, 255, 0.8) 42%, transparent 50%),
                radial-gradient(circle at 50% 100%, rgba(255,255,255,1) 0%, transparent 60%),
                url("data:image/svg+xml,%3Csvg width='40' height='69.28203230275509' viewBox='0 0 40 69.28203230275509' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ec4899' fill-opacity='0.03'%3E%3Cpath d='M0 22.82l20-11.547 20 11.547v23.094l-20 11.547-20-11.547V22.82zm2 3.464v16.17L19.236 51.7l17.528-9.246v-16.17L19.236 17.038 2 26.284z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
    ...
    <div class="w-full overflow-x-clip bg-[#f8fafc]">

        <!-- SECTION 1: HERO -->
        <section class="relative min-h-[100svh] w-full flex flex-col justify-center items-center overflow-hidden py-24 lg:py-32 bg-[#f8fafc] bg-noise-overlay border-b border-gray-100">
            <div class="absolute inset-0 z-0 bg-[#f8fafc]">
                <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/banner_ex2b-Rcl937dqFR7EP4xN.jpg" alt="Ambient Blur" class="absolute inset-0 w-full h-full object-cover opacity-30 mix-blend-multiply blur-[20px] transform scale-110">
            ...
            <div class="relative z-20 w-full max-w-7xl mx-auto px-6 text-center mb-8 md:mb-12">
                <div class="inline-flex items-center gap-3 mb-6 px-5 py-2.5 rounded-full border border-pink-200 bg-pink-50 backdrop-blur-xl reveal-up animate-float shadow-sm">
                    <span class="text-pink-600 text-[8px] md:text-[10px] tracking-[0.4em] font-bold uppercase">Dynamic Exterior</span>
                </div>

                <h1 class="font-geely text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-900 uppercase leading-[1.1] tracking-tighter mb-6 reveal-up delay-100 max-w-5xl mx-auto drop-shadow-sm">
                    A SYMPHONY OF <span class="text-gradient-premium">COLOR</span> <br> AND FUTURISTIC FORM
                </h1>
                
                <p class="text-gray-600 text-xs md:text-base font-light tracking-wide uppercase reveal-up delay-200 max-w-2xl mx-auto">
            ...
            <div class="relative z-20 w-full max-w-5xl mx-auto px-4 sm:px-6 reveal-up delay-300">
                <div class="glass-island p-2 md:p-3 rounded-[2rem] md:rounded-[2.5rem] border border-white">
                    <div class="relative w-full aspect-video md:aspect-[21/9] rounded-[1.5rem] md:rounded-[2rem] overflow-hidden bg-gray-100">
        ...
        <!-- SECTION 2: 360 VIEWER -->
        <section class="py-20 md:py-32 bg-white relative z-30 overflow-hidden border-b border-gray-100 bg-noise-overlay">
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] ambient-glow-pink opacity-50 pointer-events-none z-0"></div>
            ...
            <div class="max-w-[1600px] mx-auto px-4 md:px-12 relative z-10 text-center">
                <div class="reveal-up mb-12 md:mb-16">
                    <h2 class="font-geely text-4xl sm:text-5xl md:text-6xl lg:text-7xl uppercase tracking-tighter text-gray-900 mb-4">
                        CHOOSE YOUR <span class="text-gradient-premium">EX2</span>
                    </h2>
                    <p class="text-gray-600 text-xs sm:text-sm md:text-base font-light tracking-wide max-w-2xl mx-auto leading-relaxed">
                        Tersedia dalam berbagai pilihan warna yang mencerminkan kepribadian dinamis Anda. Jelajahi sudut pandang 360 derajat.
                    </p>
                </div>

                <div class="glass-island p-2 md:p-3 rounded-[2rem] md:rounded-[3rem] overflow-hidden reveal-scale w-full relative z-10 mb-8 aspect-video max-w-6xl mx-auto shadow-xl border-white">
                    <div class="relative w-full h-full rounded-[1.5rem] md:rounded-[2.5rem] overflow-hidden border border-gray-100">
                        <div id="360-bg-container" class="absolute inset-0 transition-colors duration-1000" style="background-color: #f8fafc;">
                            <div class="absolute inset-0 bg-studio-motif mix-blend-overlay opacity-50"></div>
                            <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.8)_0%,rgba(240,240,240,0.5)_100%)] pointer-events-none mix-blend-overlay"></div>
                            <div class="absolute inset-0 shadow-[inset_0_0_80px_rgba(0,0,0,0.05)] pointer-events-none"></div>
                        </div>
                ...
                <div class="glass-island flex flex-col md:inline-flex md:flex-row items-center justify-between md:justify-center p-4 md:py-4 md:px-8 rounded-[2rem] md:rounded-full shadow-lg border-white relative z-30 mx-auto w-full md:w-auto max-w-6xl reveal-up delay-200 gap-4 md:gap-10 backdrop-blur-3xl -mt-16 md:-mt-24 bg-white/90">
                    
                    <p id="active-color-name" class="text-[10px] md:text-[12px] font-bold tracking-[0.4em] uppercase text-center flex-1 md:flex-none transition-colors duration-300 my-2 md:my-0" style="color: #64748b;">Pearl White</p>
                    ...
                    <div class="flex items-center gap-4 shrink-0 justify-center w-full md:w-auto">
                        <div class="flex flex-wrap justify-center gap-3 transition-all duration-500">
                            <!-- Swatches diubah border defaultnya -->
                            <button class="swatch-ext active w-8 h-8 rounded-full ring-1 ring-pink-500/50 ring-offset-2 ring-offset-transparent transition-all" style="background-color: #f8f9fa;" data-src="https://riszali.sirv.com/Spins/ex2/White.spin" data-name="Pearl White" data-text-color="#64748b" data-bg-color="#f8fafc"></button>
                            <button class="swatch-ext w-8 h-8 rounded-full transition-all" style="background-color: #ffd1dc;" data-src="https://riszali.sirv.com/Spins/ex2/IceBerryPink.spin" data-name="Ice Berry Pink" data-text-color="#ec4899" data-bg-color="#fdf2f8"></button>
                            <button class="swatch-ext w-8 h-8 rounded-full transition-all" style="background-color: #e3dac9;" data-src="https://riszali.sirv.com/Spins/ex2/NebullaBeigi.spin" data-name="Nebulla Beige" data-text-color="#d97706" data-bg-color="#fefce8"></button>
                            <button class="swatch-ext w-8 h-8 rounded-full transition-all" style="background-color: #9cd1e8;" data-src="https://riszali.sirv.com/Spins/ex2/SeaSaltBlue%20().spin" data-name="Sea Salt Blue" data-text-color="#0ea5e9" data-bg-color="#f0f9ff"></button>
                            <button class="swatch-ext w-8 h-8 rounded-full transition-all" style="background-color: #7b8084;" data-src="https://riszali.sirv.com/Spins/ex2/Comet%20grey%20().spin" data-name="Comet Grey" data-text-color="#475569" data-bg-color="#f1f5f9"></button>
                            <button class="swatch-ext w-8 h-8 rounded-full transition-all" style="background-color: #c0c0c0;" data-src="https://riszali.sirv.com/Spins/ex2/Starsilver.spin" data-name="Star Silver" data-text-color="#64748b" data-bg-color="#e2e8f0"></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- SECTION 3: AWARD WINNING DESIGN -->
        <section class="relative w-full bg-[#f8fafc] bg-noise-overlay border-b border-gray-100">
            <div class="sticky top-0 w-full h-[100vh] z-0 overflow-hidden bg-white">
                <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/sketch-ex2-9YIJTReOoLDy0jje.webp" alt="Design Architecture" class="w-full h-full object-contain opacity-10 mix-blend-multiply">
                <div class="absolute inset-0 bg-gradient-to-t from-[#f8fafc] via-transparent to-[#f8fafc]"></div>
            </div>

            <div class="relative z-10 w-full">
                <div class="h-[80vh] md:h-[100vh]"></div>
                <div class="w-full max-w-7xl mx-auto px-6 pb-[30vh]">
                    <div class="glass-island p-8 md:p-12 lg:p-16 rounded-[2.5rem] max-w-3xl ml-auto reveal-up border border-white">
                        <div class="inline-flex items-center gap-3 mb-6 px-4 py-2 rounded-full border border-pink-200 bg-pink-50 text-pink-600">
                            <span class="text-[10px] tracking-[0.3em] font-bold uppercase">Award Winning Design</span>
                        </div>
                        <h2 class="font-geely text-3xl sm:text-4xl md:text-5xl text-gray-900 uppercase tracking-tighter mb-6 leading-tight">
                            PLAYFUL <br> <span class="text-gradient-premium">URBAN AESTHETICS</span>
                        </h2>
                        <p class="text-gray-600 text-sm md:text-lg leading-relaxed font-light">
        ...
        <section class="py-24 md:py-32 lg:py-48 bg-white relative z-20 overflow-hidden border-b border-gray-100 bg-noise-overlay">
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="text-center mb-16 md:mb-24 reveal-up">
                    <div class="inline-flex items-center gap-3 mb-4 px-4 py-2 rounded-full border border-pink-200 bg-pink-50 text-pink-600 shadow-sm animate-float">
                        <span class="text-[10px] tracking-[0.3em] font-bold uppercase">Philosophy</span>
                    </div>
                    <h2 class="font-geely text-4xl sm:text-5xl md:text-6xl lg:text-7xl tracking-tighter text-gray-900 leading-tight uppercase mb-6">
                        DESIGN THAT <br class="hidden md:block"> DEFINES <span class="text-gradient-premium">EVERY DETAIL</span>
                    </h2>
                    <p class="text-gray-600 text-sm md:text-base lg:text-lg font-light leading-relaxed max-w-3xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
                    <div class="lg:col-span-8 reveal-left">
                        <div class="glass-island p-2 rounded-[2.5rem] border-white overflow-hidden group shadow-lg">
                            <div class="relative aspect-[16/9] lg:aspect-[21/9] rounded-[2rem] overflow-hidden bg-gray-100">
                    ...
                    <div class="lg:col-span-4 flex flex-col justify-center reveal-right delay-200">
                        <div class="glass-panel-light p-8 md:p-10 rounded-[2.5rem] border-gray-100 bg-white/80 relative overflow-hidden h-full flex flex-col justify-center shadow-md">
                            <div class="absolute -top-20 -right-20 w-40 h-40 ambient-glow-pink opacity-50 rounded-full blur-[60px]"></div>
                            <span class="text-pink-600 font-geely text-4xl md:text-5xl mb-4 block">0.618</span>
                            <h3 class="font-geely text-2xl md:text-3xl text-gray-900 uppercase tracking-tighter mb-4 leading-tight">
                                GOLDEN <br> <span class="text-pink-500">RATIO</span>
                            </h3>
                            <div class="w-12 h-1 bg-gradient-to-r from-pink-400 to-pink-600 mb-6 rounded-full"></div>
        ...
        <!-- SECTION 5: GALLERY BENTO GRID -->
        <section class="py-16 md:py-32 relative z-20 overflow-hidden bg-[#f8fafc] bg-noise-overlay border-b border-gray-100">
            <div class="absolute top-0 right-0 w-[400px] h-[400px] ambient-glow-pink opacity-40 pointer-events-none z-0"></div>
            <div class="absolute bottom-0 left-0 w-[400px] h-[400px] ambient-glow-pink opacity-40 pointer-events-none z-0"></div>
            ...
            <div class="max-w-[1600px] mx-auto px-3 sm:px-6 relative z-10">
                ...
                <div class="md:hidden flex items-center justify-end mb-6 px-2 reveal-up">
                    <div class="flex items-center gap-1.5 text-gray-500">
                        <span class="text-[9px] tracking-widest uppercase font-bold">Tap to expand</span>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 grid-flow-dense gap-2 sm:gap-4 md:gap-6 auto-rows-[140px] sm:auto-rows-[180px] md:auto-rows-[250px]">
                    ...
                    @foreach($gallery_images as $img)
                        <div class="glass-panel-light p-1 sm:p-2 rounded-[1rem] sm:rounded-[2rem] reveal-up {{ $img['delay'] }} {{ $img['class'] }} group cursor-pointer relative overflow-hidden active:scale-[0.98] transition-transform duration-300 border-white" onclick="openLightbox('{{ $img['src'] }}')">
                            <div class="w-full h-full rounded-[0.75rem] sm:rounded-[1.5rem] overflow-hidden relative bg-gray-100">
                                <img src="{{ $img['src'] }}" alt="Gallery Geely EX2" loading="lazy" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-all duration-700">
                                <div class="absolute inset-0 bg-pink-500/10 mix-blend-overlay opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                                
                                <div class="absolute bottom-2 right-2 sm:bottom-4 sm:right-4 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/80 backdrop-blur-md flex items-center justify-center text-pink-500 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-4 group-hover:translate-y-0 border border-white shadow-sm hover:bg-pink-500 hover:text-white">
        ...
        <section class="py-24 md:py-32 bg-white relative z-20 overflow-hidden border-b border-gray-100 bg-noise-overlay">
            <div class="max-w-7xl mx-auto px-6">
                <div class="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
                    <div class="w-full lg:w-1/2 reveal-right">
                        <div class="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-pink-200 bg-pink-50 text-pink-600">
                            <span class="text-[9px] md:text-[10px] font-bold tracking-[0.3em] uppercase">Intelligence Lighting</span>
                        </div>
                        <h2 class="font-geely text-3xl sm:text-4xl md:text-5xl text-gray-900 uppercase tracking-tighter leading-tight mb-6">
                            FEATHER-INSPIRED <br> <span class="text-gradient-premium">LED HEADLIGHTS</span>
                        </h2>
                        <p class="text-gray-600 text-sm md:text-lg leading-relaxed font-light mb-10">
                        ...
                        <div class="grid grid-cols-2 gap-6 opacity-90">
                            <div class="p-5 rounded-2xl glass-panel-light border-gray-100 flex flex-col justify-center text-center shadow-sm hover:shadow-md transition-shadow">
                                <p class="text-pink-500 font-geely text-3xl md:text-4xl mb-1">170m</p>
                                <p class="text-gray-500 text-[9px] uppercase tracking-widest font-bold">Far Range</p>
                            </div>
                            <div class="p-5 rounded-2xl glass-panel-light border-gray-100 flex flex-col justify-center text-center shadow-sm hover:shadow-md transition-shadow">
                                <p class="text-gray-900 font-geely text-3xl md:text-4xl mb-1">22m</p>
        ...
        <!-- SECTION 7: WHEELS -->
        <section class="py-24 md:py-32 bg-[#f8fafc] relative z-20 overflow-hidden border-b border-gray-100 bg-noise-overlay">
            <div class="absolute top-1/2 right-0 -translate-y-1/2 w-[500px] h-[500px] ambient-glow-pink opacity-40 pointer-events-none z-0"></div>
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                    <div class="w-full lg:w-1/2 reveal-left">
                        ...
                        <h2 class="font-geely text-3xl sm:text-4xl md:text-5xl text-gray-900 uppercase tracking-tighter leading-tight mb-6">
                            16 INCH <br> <span class="text-gradient-premium">CLOVERLEAF WHEELS</span>
                        </h2>
                        <p class="text-gray-600 text-sm md:text-lg leading-relaxed font-light mb-10">
                    ...
                    <div class="w-full lg:w-1/2 reveal-right delay-100">
                        <div class="glass-island p-2 rounded-[2.5rem] border border-white overflow-hidden group shadow-lg">
        ...
        <!-- SECTION 8: CAGE BODY -->
        <section class="py-24 md:py-32 relative z-20 overflow-hidden border-b border-gray-100 bg-white bg-noise-overlay">
            ...
            <div class="max-w-[1400px] mx-auto px-4 md:px-6 relative z-10">
                <div class="glass-island p-2 rounded-[2.5rem] md:rounded-[3rem] overflow-hidden border border-white shadow-xl group">
                    <div class="relative w-full h-[550px] md:h-[650px] lg:h-[750px] rounded-[2rem] md:rounded-[2.5rem] overflow-hidden bg-gray-50">
                        <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/geely-ex2---vehicle-architecture-2DbmJoNAygKH9Fo7.jpg" 
                             ...
                             class="absolute inset-0 w-full h-full object-cover object-center opacity-80 group-hover:opacity-100 transition-all duration-[2000ms] scale-105 group-hover:scale-100">
                        ...
                        <div class="absolute inset-0 p-8 md:p-12 lg:p-20 flex flex-col justify-end lg:justify-center w-full lg:w-1/2 z-10">
                            <div class="reveal-left">
                                <div class="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-pink-200 bg-pink-50 text-pink-600 backdrop-blur-md shadow-sm animate-float">
                                    <span class="text-[9px] md:text-[10px] font-bold tracking-[0.3em] uppercase">Core Safety</span>
                                </div>
                                <h2 class="font-geely text-4xl sm:text-5xl md:text-7xl text-gray-900 uppercase tracking-tighter leading-tight mb-6 drop-shadow-sm">
                                    <span class="text-gradient-premium">CAGE</span> <br> BODY
                                </h2>
                                <div class="w-16 h-1 bg-gradient-to-r from-pink-400 to-pink-600 mb-6 rounded-full shadow-sm"></div>
                                <p class="text-gray-600 text-sm md:text-base lg:text-lg leading-relaxed font-light max-w-md">
        ...
        <!-- SECTION 9: HIGH STRENGTH FRAME -->
        <section class="py-24 md:py-32 bg-[#f8fafc] relative z-20 overflow-hidden border-b border-gray-100 bg-noise-overlay">
            <div class="absolute top-0 right-0 w-[600px] h-[600px] ambient-glow-pink opacity-40 pointer-events-none z-0"></div>
            ...
            <div class="max-w-[1500px] mx-auto relative z-10">
                <div class="relative flex flex-col lg:flex-row items-center justify-end min-h-[500px] lg:min-h-[600px]">
                    <div class="lg:absolute lg:left-0 lg:top-0 w-full lg:w-[65%] h-[350px] lg:h-full z-0 reveal-left">
                        <div class="w-full h-full relative lg:rounded-r-[3rem] overflow-hidden glass-island border-l-0 border-y-0 border-r border-white shadow-xl">
                            <div class="absolute inset-0 bg-pink-50/20 mix-blend-overlay z-10 pointer-events-none"></div>
                            <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/geely-ex2---tri-directional-structure-eJ1ix5FWjzTtiNMR.jpg" 
                                 ...
                                 class="w-full h-full object-cover transition-transform duration-[3000ms] hover:scale-105 opacity-90">
                            <div class="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-l from-[#f8fafc] via-transparent to-transparent z-10 pointer-events-none"></div>
                        </div>
                    </div>

                    <div class="w-full lg:w-1/2 px-6 lg:px-12 relative z-10 -mt-16 lg:mt-0 reveal-right delay-100">
                        <div class="glass-panel-light p-8 md:p-12 lg:p-14 rounded-[2.5rem] border-white bg-white/90 backdrop-blur-2xl shadow-[0_30px_80px_rgba(0,0,0,0.05)] relative overflow-hidden">
                            <div class="absolute -top-20 -left-20 w-40 h-40 ambient-glow-pink opacity-50 rounded-full blur-[60px] pointer-events-none"></div>
                            
                            <div class="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-pink-200 bg-pink-50 text-pink-600">
                                <span class="text-[9px] md:text-[10px] font-bold tracking-[0.3em] uppercase">Structural Integrity</span>
                            </div>
                            <h2 class="font-geely text-3xl sm:text-4xl md:text-5xl text-gray-900 uppercase tracking-tighter leading-tight mb-6">
                                HIGH-STRENGTH <br> <span class="text-gradient-premium">FRAME</span>
                            </h2>
                            <div class="w-12 h-1 bg-gradient-to-r from-pink-400 to-pink-600 mb-6 rounded-full"></div>
        ...
        <!-- SECTION 10: REAR SUB-FRAME -->
        <section class="py-24 md:py-32 bg-white relative z-20 overflow-hidden border-b border-gray-100 bg-noise-overlay">
            <div class="absolute bottom-0 right-0 w-[400px] h-[400px] ambient-glow-pink opacity-40 pointer-events-none z-0"></div>
            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10">
                <div class="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
                    <div class="w-full lg:w-5/12 reveal-right">
                        ...
                        <h2 class="font-geely text-3xl sm:text-4xl md:text-5xl text-gray-900 uppercase tracking-tighter leading-tight mb-6">
                            REAR <span class="text-pink-500">SUB-FRAME</span> <br> PROTECTION
                        </h2>
                        <div class="w-12 h-1 bg-gradient-to-r from-pink-400 to-pink-600 mb-6 rounded-full"></div>
                        <p class="text-gray-600 text-sm md:text-lg leading-relaxed font-light">
                    ...
                    <div class="w-full lg:w-7/12 reveal-left delay-100">
                        <div class="glass-island p-2 rounded-[2.5rem] border-white overflow-hidden group shadow-[0_20px_50px_rgba(0,0,0,0.05)] bg-gray-50">
                            <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/geely-ex2---rear-subprotection-frame-MlES29BzY3UTLzl8.jpg" alt="Rear Sub-Frame Protection" class="w-full h-auto rounded-[2rem] transition-transform duration-[2000ms] group-hover:scale-105 opacity-90 group-hover:opacity-100 mix-blend-multiply">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- SECTION 11: DIVE INTO DETAILS -->
        <section id="details" class="py-16 md:py-24 lg:py-32 relative z-30 bg-[#f8fafc] overflow-hidden bg-noise-overlay border-b border-gray-100">
            <div class="absolute top-1/2 right-0 -translate-y-1/2 w-[500px] h-[500px] ambient-glow-pink opacity-40 pointer-events-none z-0"></div>
            ...
            <div class="max-w-[1600px] w-full mx-auto px-4 sm:px-8 md:px-12 lg:px-16 relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
                    <div class="order-2 lg:order-1 lg:col-span-7 flex flex-col gap-4 reveal-left w-full">
                        <a href="{{ route('models.ex2.exterior') }}" class="relative block w-full h-[120px] sm:h-[160px] lg:h-[200px] rounded-[1.5rem] overflow-hidden group shadow-md border-2 border-pink-500 cursor-pointer p-1 glass-island">
                            <div class="relative w-full h-full rounded-[1.2rem] overflow-hidden bg-gray-100">
                                ...
                                <div class="absolute inset-0 p-6 md:p-8 flex items-end justify-between">
                                    <div>
                                        <p class="text-pink-400 text-[10px] uppercase font-bold tracking-widest mb-1 drop-shadow-md">Currently Viewing</p>
                                        <h3 class="text-white font-geely text-2xl md:text-4xl uppercase tracking-tighter drop-shadow-md">Exterior</h3>
                                    </div>
                                    <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-pink-500 backdrop-blur-md flex items-center justify-center text-white shadow-lg">
                        ...
                        <a href="{{ route('models.ex2') }}#experience" class="relative block w-full h-[120px] sm:h-[160px] lg:h-[200px] rounded-[1.5rem] overflow-hidden group shadow-sm hover:shadow-lg transition-shadow duration-500 border border-white p-1 glass-panel-light">
                            <div class="relative w-full h-full rounded-[1.2rem] overflow-hidden bg-gray-100">
                                ...
                                <div class="absolute inset-0 p-6 md:p-8 flex items-end justify-between">
                                    <div>
                                        <p class="text-gray-300 text-[10px] uppercase font-bold tracking-widest mb-1 group-hover:text-pink-400 transition-colors">Discover</p>
                                        <h3 class="text-white font-geely text-2xl md:text-4xl uppercase tracking-tighter drop-shadow-md">Interior</h3>
                                    </div>
                                    <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white group-hover:bg-pink-500 transition-colors duration-300">
                        ...
                        <a href="{{ route('models.ex2.specification') }}" class="relative block w-full h-[120px] sm:h-[160px] lg:h-[200px] rounded-[1.5rem] overflow-hidden group shadow-sm hover:shadow-lg transition-shadow duration-500 border border-white p-1 glass-panel-light">
                            <div class="relative w-full h-full rounded-[1.2rem] overflow-hidden bg-gray-100">
                                ...
                                <div class="absolute inset-0 p-6 md:p-8 flex items-end justify-between">
                                    <div>
                                        <p class="text-gray-300 text-[10px] uppercase font-bold tracking-widest mb-1 group-hover:text-pink-400 transition-colors">Learn More</p>
                    ...
                    <div class="order-1 lg:order-2 lg:col-span-5 flex flex-col gap-8 reveal-right delay-200 w-full">
                        <div class="glass-island p-6 md:p-8 rounded-[1.5rem] md:rounded-[2rem] flex flex-col shadow-xl relative overflow-hidden group hover:border-pink-200 transition-colors duration-500 border-white bg-white/90">
                            ...
                            <div class="w-full relative mt-8 opacity-40 group-hover:opacity-60 transition-opacity duration-500">
                                <img src="https://assets.zyrosite.com/Yle46KEPN6IkVONg/sketch-ex2-9YIJTReOoLDy0jje.webp" alt="EX2 Sketch" loading="lazy" class="w-full h-auto object-contain mix-blend-multiply">
                            </div>
                        </div>

                        <div class="flex flex-col gap-3 w-full">
                            <a href="{{ route('models.ex2.specification') }}" class="w-full py-4 md:py-5 rounded-full bg-pink-500 text-white font-bold text-[10px] md:text-xs tracking-[0.2em] uppercase text-center hover:bg-pink-600 transition-colors duration-300 shadow-[0_10px_20px_rgba(236,72,153,0.3)] btn-shimmer">
                                Show Full Specs
                            </a>
    ...
    <!-- LIGHTBOX LIGHT THEME (Dari Index) -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            swatches.forEach(swatch => {
                swatch.addEventListener('click', () => {
                    ...
                    // Tambahkan kelas active untuk tema terang
        ...
        window.openLightbox = function(imgSrc) {
            ...
            lightboxImg.classList.add('bg-white', 'p-4'); // Tambahan padding putih
